...
<center>										
<p><u><b><font size = "32">Thank you for adding a gallery!</font></b></u></p>
...
try{
	...
	s.executeUpdate("insert into gallery(gallery_id, name, description) values (default,'" + name + "','" + description + "')");
